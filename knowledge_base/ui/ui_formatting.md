...
title: UI Formatting & Display Primitives
...
- **Execution Flow**:
    ...
    3. **Rendering**: Writes the buffer to `PPU_DATA` while handling VBlank synchronization via `waitNMI50`.
