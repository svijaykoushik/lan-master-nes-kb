...
* [System](knowledge_base/system/) - Hardware interfaces and core system modules.
    ...
    - [Timing & Sync](knowledge_base/system/timing_sync.md) - VBlank and NMI synchronization.
    - [Rendering](knowledge_base/system/rendering.md) - PPU mapping and tile updates.
    - [OAM Management](knowledge_base/system/oam_management.md) - Sprite buffer and cursor logic.
    - [RNG Subsystem](knowledge_base/system/rng.md) - Galois LFSR pseudo-random generation.
...
* [Logic](knowledge_base/logic/) - Game rules and connectivity engines.
    ...
    - [Password System](knowledge_base/logic/passwords.md) - Passcode verification and level unlocking.
...
* [UI](knowledge_base/ui/) - Menu systems and visual interfaces.
    ...
    - [UI Formatting](knowledge_base/ui/ui_formatting.md) - Number and table rendering primitives.
