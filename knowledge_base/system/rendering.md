...
title: Tile Rendering & PPU Mapping
...
The internal tile ID from `GAME_MAP` is used to index into the `tilesTable` (see [Pattern Mapping](/knowledge_base/assets/pattern_mapping.md)). Each entry in `tilesTable` provides four bytes of data:
